...
class BlockChainEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # print(action_dict)
        #
        # action_dict['no_consensus_algorithm'] = action_dict['no_consensus_algorithm']*3
        # action_dict['block_size'] = action_dict['block_size'] * BLOCK_SIZE_LIMIT
        # action_dict['block_interval'] = action_dict['block_interval'] * MAX_BLOCK_INTERVAL
